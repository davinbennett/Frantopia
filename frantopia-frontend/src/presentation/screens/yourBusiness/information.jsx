...
const InformationYourBusiness = ( { orderId, productId, packageId, productName } ) =>
{
   ...
   useEffect( () =>
   {
      const fetchOrderData = async () =>
      {
         try
         {
            const details = await fetchInformationController( jwtToken, productId );
...
export default InformationYourBusiness;